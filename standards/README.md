# Ahara Project Standards

These standards apply to all projects under the ahara umbrella. AI agents working in any project should follow these conventions.

## Index

| Standard | Description |
|----------|-------------|
| [project-structure.md](project-structure.md) | Directory layout, naming conventions, required files |
| [scripts.md](scripts.md) | Deploy scripts, Makefiles, parameterless execution |
